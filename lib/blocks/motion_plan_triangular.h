#ifndef MOTION_PLAN_TRIANGULAR_H
#define MOTION_PLAN_TRIANGULAR_H

#include "generic_block.h"

class MotionPlanTriangular : public Block {
  ...
  public:
    ...
    /**
     * @brief Updates the instantaneous position, velocity, and acceleration values.
     * Updates the instantaneous position, velocity, and acceleration values per timestep inputted.
     */
    void tick() override;
};

#endif MOTION_PLAN_TRIANGULAR_H